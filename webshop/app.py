...
PRODUCTS = [
    ...
    },
    {
        ...
        'category': 'Patike',
        'subcategory': 'Nike',
        'image': 'https://sneakernews.com/wp-content/uploads/2017/08/nike-air-max-90-black-white-537384-082-1.jpg',
        'delivery': '2-4 days',
        'type': 'Muške/Ženske',
        'season': 'Sve godine',
    ...
    },
    {
        ...
        'category': 'Patike',
        'subcategory': 'Buzz',
        'image': 'https://www.buzzsneakers.rs/files/images/buzz/buzz_logo.png',
        'delivery': '2-4 days',
        'type': 'Uniseks',
        'season': 'Sve godine',
    ...
    },
    {
        ...
        'category': 'Patike',
        'subcategory': 'Djak',
        'image': 'https://tse1.mm.bing.net/th/id/OIP.TjLXvFiSDt5Y8vr9HuC-9gAAAA?rs=1&pid=ImgDetMain&o=7&rm=3',
        'delivery': '2-4 days',
        'type': 'Uniseks',
        'season': 'Sve godine',
    ...
    },
    {
        ...
        'type': 'Uniseks',
        'season': 'Sve godine',
        'description': 'Minimalni dizajn na crnoj majici sa nike logom. Kombinuje se sa sve. Osnovni komad garderobe.',
    },
    # Odeća - Dukserice
    {
        'id': 9,
    ...
    },
    {
        ...
        'category': 'Odeća',
        'subcategory': 'Dukserice',
        'image': 'https://i.pinimg.com/originals/95/a6/c4/95a6c4ae71f64dca4d9e5083ca85cbc8.jpg',
        'delivery': '1-3 days',
        'type': 'Uniseks',
        'season': 'Jesen/Zima',
    ...
    {
        'id': 13,
        'name': 'Pantalone (Bandana small print)',
        'price': 27,
        'category': 'Odeća',
        'subcategory': 'Pantalone',
        'image': 'https://i.pinimg.com/originals/a1/68/27/a16827752926c069f4413d0705145d53.jpg',
        'delivery': '1-3 days',
        'type': 'Uniseks',
        'season': 'Sve godine',
    ...
    {
        'id': 14,
        'name': 'Šorcevi (Bandana print)',
        'price': 23,
        'category': 'Odeća',
        'subcategory': 'Šorcevi',
        'image': 'https://tse2.mm.bing.net/th/id/OIP.HqS3T1z0-Mj5Sg9awpJvnAHaHa?rs=1&pid=ImgDetMain&o=7&rm=3',
        'delivery': '1-3 days',
        'type': 'Uniseks',
        'season': 'Leto',
    ...
    # Nakit - Ogrlice
    {
        ...
        'category': 'Nakit',
        'subcategory': 'Ogrlice',
        'image': 'https://images.asos-media.com/products/reclaimed-vintage-inspired-unisex-everyday-chain-necklace-in-silver/203060911-1-silver?$n_640w$&wid=513&fit=constrain',
        'delivery': '1-3 days',
        'type': 'Uniseks',
        'season': 'Sve godine',
    ...
    {
        'id': 15,
        'name': 'Srebrna narukvica (Koža)',
        'price': 65,
        'category': 'Nakit',
        'subcategory': 'Narukvice',
        'image': 'https://tse1.mm.bing.net/th/id/OIP.oHMXmhjodtOiWdrjTj9xUgHaHa?rs=1&pid=ImgDetMain&o=7&rm=3',
        'delivery': '1-3 days',
        'type': 'Uniseks',
        'season': 'Sve godine',
    ...
    },
    {
        ...
        'image': 'https://tse4.mm.bing.net/th/id/OIP.7LeI4yJhkACbDVlzknFXpAHaHa?rs=1&pid=ImgDetMain&o=7&rm=3',
        'delivery': '1-3 days',
        'type': 'Uniseks',
        'season': 'Sve godine',
        'description': 'Premium srebrni prsten sa sitnim detaljima. Komad koji vrijednosti raste. Savršen poklon.',
    },
]
